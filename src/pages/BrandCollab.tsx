const brands = [
  ...
  { name: "Reebok",         bg: "#cc0000", text: "#ffffff", abbr: "Reebok" },
  { name: "Lululemon",      bg: "#6d2077", text: "#ffffff", abbr: "lululemon" },
  { name: "Louis Vuitton",  bg: "#1a1200", text: "#c4a44a", abbr: "LV" },
  { name: "Gucci",          bg: "#0a0a0a", text: "#c8a96e", abbr: "GUCCI" },
  { name: "Supreme",        bg: "#d00000", text: "#ffffff", abbr: "Supreme" },
  { name: "Tesla",          bg: "#cc0000", text: "#ffffff", abbr: "TESLA" },
  { name: "Lamborghini",    bg: "#1a1200", text: "#d4a017", abbr: "LAMBO" },
  { name: "Rolex",          bg: "#006039", text: "#ffd700", abbr: "ROLEX" },
  { name: "Balenciaga",     bg: "#0a0a0a", text: "#ffffff", abbr: "Balenciaga" },
  { name: "Off-White",      bg: "#111",    text: "#f5f5f5", abbr: "OFF-WHITE" },
  { name: "Monster Energy", bg: "#000000", text: "#a4ce38", abbr: "Monster" },
  { name: "Beats",          bg: "#cc0000", text: "#ffffff", abbr: "beats" },
  { name: "Fenty Beauty",   bg: "#1a0a10", text: "#e0b4c8", abbr: "FENTY" },
  { name: "Glossier",       bg: "#f9d6e0", text: "#c05f7a", abbr: "glossier" },
  { name: "Shein",          bg: "#000000", text: "#e30013", abbr: "SHEIN" },
  { name: "H&M",            bg: "#d10019", text: "#ffffff", abbr: "H&M" },
  { name: "Zara",           bg: "#0a0a0a", text: "#f5f5f5", abbr: "ZARA" },
  { name: "Bang & Olufsen", bg: "#1a1a1a", text: "#c8a96e", abbr: "B&O" },
];
