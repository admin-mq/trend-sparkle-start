          ...
          {visibility.length > 0 && (
            <div className="page-break-before" style={{ marginBottom: 36 }}>
              ...
              <p style={{ fontSize: 12, color: "#6b7280", marginBottom: 14, lineHeight: 1.6 }}>
                For each query below, Marketers Quest ran a live AI web search and checked whether <strong>{project.brand_name}</strong>'s domain appeared in the real source citations returned (or its name in the answer text).
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {visibility.map((v, i) => {
